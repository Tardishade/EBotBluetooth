        ...
        joystick.setOnJoystickMoveListener(new OnJoystickMoveListener() {
            ...
            public void onValueChanged(int angle, int power, int direction) {
                ...
                if(myThreadConnected != null){
                    ...
                    myValue = "8" + "w" + Integer.toString((int) ((((floatPower / 100) * 1) + 2) * 100))
                            + ";" + Integer.toString((int) ((((floatPower / 100) * 1) + 2) * 100));
                    byte[] bytesToSend = myValue.getBytes();
                    myThreadConnected.write(bytesToSend);

                    debugView.setText(myValue);
...

            {
                ...
                if (myThreadConnected != null) {
                    byte[] bytesToSend = "11<E".getBytes();
                    myThreadConnected.write(bytesToSend);
                    bytesToSend = "11<O".getBytes();
                    myThreadConnected.write(bytesToSend);
                    bytesToSend = "F".getBytes();
                    myThreadConnected.write(bytesToSend);
                }
